...
from .kie_api.gpt_image2_t2i import (
    ASPECT_RATIO_OPTIONS as GPTIMAGE2_T2I_ASPECT_RATIO_OPTIONS,
    RESOLUTION_OPTIONS as GPTIMAGE2_T2I_RESOLUTION_OPTIONS,
    run_gpt_image2_text_to_image,
)
from .kie_api.gpt_image2_i2i import (
    ASPECT_RATIO_OPTIONS as GPTIMAGE2_I2I_ASPECT_RATIO_OPTIONS,
    RESOLUTION_OPTIONS as GPTIMAGE2_I2I_RESOLUTION_OPTIONS,
...
Generate an image from a prompt using OpenAI's GPT Image 2 via Kie.ai.

Inputs:
- prompt: Text prompt (required, up to 20,000 chars)
- aspect_ratio: auto | 1:1 | 9:16 | 16:9 | 4:3 | 3:4
- resolution: 1K | 2K | 4K
  - 1:1 cannot output 4K (Kie.ai constraint)
  - auto only supports 1K (Kie.ai constraint)
...
"""
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "aspect_ratio": ("COMBO", {"options": GPTIMAGE2_T2I_ASPECT_RATIO_OPTIONS, "default": "1:1"}),
                "resolution": ("COMBO", {"options": GPTIMAGE2_T2I_RESOLUTION_OPTIONS, "default": "2K"}),
                "log": ("BOOLEAN", {"default": True}),
            },
        }
...
class KIE_GPTImage2_I2I:
    HELP = """
KIE GPT Image 2 Image-To-Image

Edit / transform / extend an input image with GPT Image 2 via Kie.ai.

Inputs:
- prompt: Edit prompt (required, up to 20,000 chars)
- images: Source image batch (up to 16 reference images; all uploaded)
- aspect_ratio: auto | 1:1 | 9:16 | 16:9 | 4:3 | 3:4
- resolution: 1K | 2K | 4K
  - 1:1 cannot output 4K (Kie.ai constraint)
  - auto only supports 1K (Kie.ai constraint)
...
"""
    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                "aspect_ratio": ("COMBO", {"options": GPTIMAGE2_I2I_ASPECT_RATIO_OPTIONS, "default": "1:1"}),
                "resolution": ("COMBO", {"options": GPTIMAGE2_I2I_RESOLUTION_OPTIONS, "default": "2K"}),
                "log": ("BOOLEAN", {"default": True}),
            },
        }
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "KIE_GPTImage2_T2I": "KIE GPT Image 2 (T2I)",
    "KIE_GPTImage2_I2I": "KIE GPT Image 2 (I2I)",
